"""
ai_catch_win_engine/feature_table.py — بناء جدول ميزات يومي (feature table) لسهم
...
راجع تاريخ git لو احتجت مراجعتها). يبقى اسم الحزمة `ai_catch_win_engine` للمرجعية
...
يُصدَّر كـCSV واحد (`runs/ai_catch_win_engine/feature_tables/{ticker}.csv`) —
...
OUTPUT_ROOT = Path("../runs/ai_catch_win_engine/feature_tables")
